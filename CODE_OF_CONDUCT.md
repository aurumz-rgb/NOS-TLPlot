# Code of Conduct for NOS-TLPlot

## Our Pledge

In the interest of fostering an open, inclusive, and safe environment, we as contributors and maintainers of **NOS-TLPlot** pledge to respect all people who engage with our project, including users, contributors, and collaborators.
...
Maintainers of NOS-TLPlot will review reports and respond appropriately, which may include:
...
This Code of Conduct applies to all interactions involving **NOS-TLPlot**, including:
...
By participating in NOS-TLPlot—whether using the tool, contributing code, validating data, or providing feedback—you agree to follow this Code of Conduct.
